  ...
  <div className="relative">
    ...
    <div className="relative h-64 md:h-80 bg-gradient-to-b from-gray-700 to-gray-800 animate-pulse">
      <div className="absolute bottom-0 left-0 w-full p-6 flex items-end">
        {/* 海报骨架 */}
        <div className="hidden md:block w-36 h-52 relative mr-6 flex-shrink-0 bg-gray-700 rounded-2xl"></div>
        <div>
          {/* 标题骨架 */}
          <div className="h-8 bg-gray-700 rounded-2xl w-3/4 mb-4"></div>
          {/* 信息骨架 */}
          <div className="flex flex-wrap items-center mt-2">
            <div className="h-4 bg-gray-700 rounded-2xl w-16 mr-4"></div>
            <div className="h-4 bg-gray-700 rounded-2xl w-20 mr-4"></div>
            <div className="h-4 bg-gray-700 rounded-2xl w-16 mr-4"></div>
          </div>
    ...
    <div className="bg-gray-900 p-4">
      <div className="flex flex-wrap items-center justify-center gap-3">
        ...
        <div className="h-10 bg-gray-700 rounded-2xl w-40"></div>
      </div>
    </div>
    ...
    <div className="p-6">
      {/* 概述骨架 */}
      <div className="mb-6">
        <div className="h-6 bg-gray-700 rounded-2xl w-32 mb-3"></div>
        <div className="h-4 bg-gray-700 rounded-2xl w-full mb-2"></div>
        <div className="h-4 bg-gray-700 rounded-2xl w-full mb-2"></div>
        <div className="h-4 bg-gray-700 rounded-2xl w-3/4"></div>
      </div>

      {/* 演员骨架 */}
      <div className="mb-6">
        <div className="h-6 bg-gray-700 rounded-2xl w-40 mb-3"></div>
        <div className="h-4 bg-gray-700 rounded-2xl w-40 mb-3"></div>
        <div className="mt-3 grid grid-cols-2 md:grid-cols-5 gap-4">
          {[1, 2, 3, 4, 5].map((i) => (
            <div key={i} className="text-center">
              <div className="w-full aspect-square bg-gray-700 rounded-2xl mb-2"></div>
              <div className="h-4 bg-gray-700 rounded-2xl w-3/4 mx-auto mb-1"></div>
              <div className="h-3 bg-gray-700 rounded-2xl w-1/2 mx-auto"></div>
            </div>
          ))}
        </div>
      </div>
      ...
      {/* 剧照骨架 */}
      <div>
        <div className="h-6 bg-gray-700 rounded-2xl w-24 mb-3"></div>
        <div className="grid grid-cols-2 gap-2">
          {[1, 2, 3, 4].map((i) => (
            <div key={i} className="relative aspect-video bg-gray-700 rounded-2xl"></div>
          ))}
        </div>
      </div>
    </div>
...
export default function MovieDetail({ movieId, onClose }: MovieDetailProps) {
  ...
  return (
    <AnimatePresence>
      ...
      >
        <motion.div
          className="bg-gray-900 w-full max-w-4xl max-h-[90vh] rounded-2xl overflow-hidden shadow-2xl"
          ...
          <div className="overflow-y-auto max-h-[90vh] custom-scrollbar">
            {loading ? (
              ...
              <div className="relative">
                ...
                <button
                  onClick={onClose}
                  className="absolute top-4 right-4 z-10 bg-black bg-opacity-50 rounded-lg p-2 hover:bg-opacity-75 transition-all"
                  aria-label="Close"
                >
                ...
                <div className="bg-gray-900 p-4">
                  <div className="flex flex-wrap items-center justify-center gap-3">
                    <a
                      ...
                      className="flex items-center gap-1 px-4 py-2 bg-yellow-500 text-black font-bold rounded-lg hover:bg-yellow-400 transition-colors"
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center gap-1 px-4 py-2 bg-blue-600 text-white font-bold rounded-lg hover:bg-blue-500 transition-colors"
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                      {streamingPlatforms.map((platform) => (
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className={`${platform.color} ${platform.textColor} py-2 px-4 rounded-lg text-center font-medium hover:opacity-90 transition-opacity flex items-center justify-center gap-2`}
